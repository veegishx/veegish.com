		...
		>
			<div className="flex items-start justify-between gap-2 mb-2">
				<div className="flex items-center gap-2">
					...
					<h3 className="font-mono text-sm font-medium text-zinc-900 dark:text-zinc-100 group-hover:text-(--color-zag-accent-dark) dark:group-hover:text-(--color-zag-accent-light) truncate">
						{repo.name}
					</h3>
				</div>
			</div>
